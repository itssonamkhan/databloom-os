        ...
        {MOCHI_MOODS.map((option) => {
          ...
          return (
            <motion.button
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.96 }}
              className={`inline-flex min-h-11 items-center rounded-full border px-3 py-2 text-sm font-semibold shadow-sm transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-500 ${
                selected
